...
States should be entered as a two letter abbreviation.
    ...
    print(enddate)
    print("Enter two letter state abbreviation, or several of them separated by commas. Do not use quotation marks.")
    print("Ex:         NY        or        NY, NJ, MA         or        ny, nj, ma")
    states = [x.strip().upper() for x in input("States: ").split(",")]
    print(states)
