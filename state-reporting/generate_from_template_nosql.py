    ...
    for state in states:
        if state.lower() not in stateswtemplates:
            ...
            if export is not None:
                ...
                temporary
                """
                export.loc[export['Ordering Facility']=="SFW Capital",'Ordering Facility Phone'] = "914-510-8910"
                export.loc[export['Ordering Facility']=="Perceptive Advisors",'Ordering Facility Phone'] = "6462055341"
